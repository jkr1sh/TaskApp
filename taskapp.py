...
def flushTable():
    ...
    flushQueries = [
        "ALTER TABLE {} AUTO_INCREMENT = 1;".format(utable),
        "SET @counter = 0;",
        "UPDATE {} SET Taskid = @counter := @counter + 1;".format(utable),
        "ALTER TABLE {} MODIFY Taskid INT AUTO_INCREMENT;".format(utable)
    ]

    for query in flushQueries:
